...
function getIdsBeforeThisPart(cache: CacheForRundownPlaylist, nextPart: DBPart) {
	const PROFILE_ID = profiler.startProfiling(`getIdsBeforeThisPart`, ProfilerLevel.DETAILED)
...
export function syncPlayheadInfinitesForNextPartInstance(
	...
	const PROFILE_ID = profiler.startProfiling(`syncPlayheadInfinitesForNextPartInstance`, ProfilerLevel.DETAILED)
