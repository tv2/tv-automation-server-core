...
import { IActionExecutionContext, ISyncIngestUpdateToPartInstanceContext, IStudioContext, IPartEventContext, IRundownContext, IStudioUserContext, ISegmentUserContext, IShowStyleUserContext, ICommonContext, ITimelineEventContext, IRundownDataChangedEventContext, IRundownTimingEventContext } from './context';
import { IngestAdlib, ExtendedIngestRundown, IngestSegment } from './ingest';
import { IBlueprintExternalMessageQueueObj } from './message';
import { MigrationStep } from './migrations';
import { IBlueprintAdLibPiece, IBlueprintPart, IBlueprintPiece, IBlueprintResolvedPieceInstance, IBlueprintRundown, IBlueprintRundownPlaylistInfo, IBlueprintSegment, IBlueprintRundownDB, IBlueprintPieceInstance, IBlueprintPartInstance, IBlueprintAdLibPieceDB, IBlueprintPartDB, ExpectedPlayoutItemGeneric } from './rundown';
...
export interface StudioBlueprintManifest extends BlueprintManifestBase {
    ...
    getShowStyleId: (context: IStudioUserContext, showStyles: IBlueprintShowStyleBase[], ingestRundown: ExtendedIngestRundown) => string | null;
    /** Returns information about the playlist this rundown is a part of, return null to not make it a part of a playlist */
    getRundownPlaylistInfo?: (context: IStudioUserContext, rundowns: IBlueprintRundownDB[]) => BlueprintResultRundownPlaylist | null;
...
export interface ShowStyleBlueprintManifest extends BlueprintManifestBase {
    ...
    getShowStyleVariantId: (context: IStudioUserContext, showStyleVariants: IBlueprintShowStyleVariant[], ingestRundown: ExtendedIngestRundown) => string | null;
    ...
    executeAction?: (context: IActionExecutionContext, actionId: string, userData: ActionUserData, triggerMode?: string) => void;
    ...
    onTimelineGenerate?: (context: ITimelineEventContext, timeline: OnGenerateTimelineObj[], previousPersistentState: TimelinePersistentState | undefined, previousPartEndState: PartEndState | undefined, resolvedPieces: IBlueprintResolvedPieceInstance[]) => Promise<BlueprintResultTimeline>;
    ...
    getEndStateForPart?: (context: IRundownContext, previousPersistentState: TimelinePersistentState | undefined, previousPartEndState: PartEndState | undefined, resolvedPieces: IBlueprintResolvedPieceInstance[], time: number) => PartEndState;
...
export declare type BlueprintResultStudioBaseline = BlueprintResultBaseline;
