...
import { ActionExecutionContext, SyncIngestUpdateToPartInstanceContext, AsRunEventContext, EventContext, IStudioConfigContext, IStudioContext, PartEventContext, RundownContext, SegmentContext, ShowStyleContext, TimelineEventContext } from './context';
import { IngestAdlib, ExtendedIngestRundown, IngestSegment } from './ingest';
import { IBlueprintExternalMessageQueueObj } from './message';
import { MigrationStep } from './migrations';
import { IBlueprintAdLibPiece, IBlueprintPart, IBlueprintPiece, IBlueprintResolvedPieceInstance, IBlueprintRundown, IBlueprintRundownPlaylistInfo, IBlueprintSegment, IBlueprintRundownDB, IBlueprintPieceInstance, IBlueprintPartInstance, IBlueprintAdLibPieceDB, IBlueprintPartDB } from './rundown';
...
export interface ShowStyleBlueprintManifest extends BlueprintManifestBase {
     ...
     */
    syncIngestUpdateToPartInstance?: (context: SyncIngestUpdateToPartInstanceContext, existingPartInstance: BlueprintSyncIngestPartInstance, newData: BlueprintSyncIngestNewData, playoutStatus: 'current' | 'next') => void;
    /** Execute an action defined by an IBlueprintActionManifest */
    executeAction?: (context: EventContext & ActionExecutionContext, actionId: string, userData: ActionUserData, triggerMode?: string) => void;
    /** Generate adlib piece from ingest data */
    getAdlibItem?: (context: ShowStyleContext, ingestItem: IngestAdlib) => IBlueprintAdLibPiece | IBlueprintActionManifest | null;
