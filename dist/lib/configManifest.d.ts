...
export declare type ConfigManifestEntry = ConfigManifestEntryBase | ConfigManifestEnumEntry | TableConfigManifestEntry | ConfigManifestEnumEntry | ConfigManifestIntEntry | ConfigManifestFloatEntry | SubDeviceConfigManifestEntry;
...
export interface ConfigManifestEntryDefault extends ConfigManifestEntryBase {
    type: Exclude<ConfigManifestEntryType, ConfigManifestEntryType.ENUM | ConfigManifestEntryType.INT | ConfigManifestEntryType.FLOAT>;
}
...
export declare type MappingsManifest = Record<string, MappingManifestEntry[]>;
export interface MappingManifestEntryProps {
    optional?: boolean;
    includeInSummary?: boolean;
}
export declare type MappingManifestEntry = MappingManifestEntryProps & (ConfigManifestEntryDefault | ConfigManifestEnumEntry | ConfigManifestIntEntry | ConfigManifestFloatEntry);
