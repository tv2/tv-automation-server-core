...
class CoreConnection extends events_1.EventEmitter {
    ...
    static generateCredentials() {
        return {
            deviceId: random_1.Random.id(),
            deviceToken: random_1.Random.id()
        };
    }
    async init(ddpOptionsORParent) {
        this._destroyed = false;
        ...
        if (ddpOptionsORParent instanceof CoreConnection) {
            ...
            this._timeSync = new timeSync_1.TimeSync({
                ...
                let stat = await this.callMethod(corePeripherals_1.PeripheralDeviceAPI.methods.getTimeDiff);
    ...
    async destroy() {
        ...
        await Promise.all(_.map(this._children, (child) => {
    ...
    async subscribe(publicationName, ...params) {
        return new Promise((resolve, reject) => {
            if (!this.ddp.ddpClient) {
    ...
    unsubscribe(subscriptionId) {
        var _a;
        (_a = this.ddp.ddpClient) === null || _a === void 0 ? void 0 : _a.unsubscribe(subscriptionId);
    ...
    getCurrentTime() {
        var _a;
        return ((_a = this._timeSync) === null || _a === void 0 ? void 0 : _a.currentTime()) || 0;
    }
    hasSyncedTime() {
        var _a;
        return ((_a = this._timeSync) === null || _a === void 0 ? void 0 : _a.isGood()) || false;
    }
    syncTimeQuality() {
        var _a;
        return ((_a = this._timeSync) === null || _a === void 0 ? void 0 : _a.quality) || null;
    }
    ...
    _sendInit() {
        ...
        let options = {
            ...
            parentDeviceId: ((_a = this._parent) === null || _a === void 0 ? void 0 : _a.deviceId) || undefined,
